...
import static reports.reporting.reportportal.Utils.generateReportPortalURL;
...
public class ScenarioReporter {
     ...
     */
    public static void handleBeforeFeature(Feature feature) throws IOException {
        if (getReportPortalURL() == null) {
            generateReportPortalURL();
        }
        String featureUri = Utils.getURI(feature);
     ...
     */
    public static void handleAfterFeature(FeatureResult featureResult, ExecutionContext executionContext) throws
     ...
     * @return the start test item rq
     */
    protected static StartTestItemRQ buildStartScenarioRq(ScenarioResult scenarioResult, ExecutionContext
            executionContext) {
        StartTestItemRQ rq = new StartTestItemRQ();
    ...
    private static FinishTestItemRQ buildStopScenarioRq(ScenarioResult scenarioResult, ExecutionContext
            executionContext) {
        Date now = Calendar.getInstance().getTime();
        FinishTestItemRQ rq = new FinishTestItemRQ();
        String featureUri = Utils.getURI(scenarioResult.getScenario().getFeature());
    ...
    public void setFeatureNamePrefix(String featureNamePrefix) {
        ScenarioReporter.featureNamePrefix = featureNamePrefix;
    }
