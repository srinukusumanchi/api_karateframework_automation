@Segmentation_TestData @CLI4482_OutboundSegmentation_TestCases_TestData
Feature: Create test data for Pre-Approved Credit Limit Increase - Segmentation test cases
  ...
  @CreditLimitIncrease @CLI4482_Outbound_Segmentation_TestCases_TestData @4482 @OUTBOUND @VS18076
  Scenario: Pre-Approved Credit Limit Increase - AMEX CLI - CoBorrower_VS18076_4482_OUTBOUND Create test data for Positive Test Cases
    ...
    * table examples
      ...
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,has ScotiaCard_XBY9"                        | acct_num      | ""               | card_Number |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,has ScotiaCard_XBY9_AC_1(LESSER acct_odt)"  | acct_num_One  | scd_num          | ""          |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,has ScotiaCard_XBY9_AC_2(greater acct_odt)" | acct_num_two  | scd_num_one      | ""          |
 ...
 # insert the created Card Number into the CUST_ACCT_RLTNP_DIM sheet
  ...
  @CreditLimitIncrease @CLI4482_Outbound_Segmentation_TestCases_TestData @4482 @OUTBOUND @VS18076
  Scenario Outline: Pre-Approved Credit Limit Increase - AMEX CLI - CoBorrower_VS18076_4482_OUTBOUND Create test data for Positive Test Cases
    * def testId = <TestID>
 ...
 # insert the created Card Number into the CUST_ACCT_RLTNP_DIM sheet
    ...
    * call read('classpath:channels/outbound/ReusableScenarios.feature@ACCT_DIM_Insertion_Database')
    ...
    Examples:
      | TestID                                                  |
      | "4482_DNS=N,PRIM_PROV_CD=Quebec,No ScotiaCard_XBY9"     |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,No ScotiaCard_XBY9" |
      | "4482_DNS=Y,PRIM_PROV_CD=Quebec,No ScotiaCard_XBY9"     |
      | "4482_DNS=Y,PRIM_PROV_CD=Non-Quebec,No ScotiaCard_XBY9" |


  @CreditLimitIncrease @CLI4482_Outbound_Segmentation_TestCases_TestData @4482 @OUTBOUND @VS18076
  Scenario Outline: Pre-Approved Credit Limit Increase - AMEX CLI - Co Borrower_VS18076_4482_OUTBOUND Segmentation
    ...
    * call read('classpath:channels/outbound/ReusableScenarios.feature@CUST_ACCT_RLTNP_DIM_Insertion_Database') examples
    ...
    Examples:
      | TestID                                                                             |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL<30Days & MOB>30days_XBY9"   |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL<30Days & MOB is NULL_XBY9"  |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL>30Days & MOB<30days_XBY9"   |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL is NULL & MOB<30days_XBY9"  |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL<30Days & MOB<30days_XBY9"   |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL>30Days & MOB>30days_XBY9"   |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL>30Days & MOB is NULL_XBY9"  |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL is NULL & MOB>30days_XBY9"  |
      | "4482_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL is NULL & MOB is NULL_XBY9" |
      | "4482_DNS=N,PRIM_PROV_CD=Quebec,has ScotiaCard_XBY9"                               |
      | "4482_DNS=Y,PRIM_PROV_CD=Non-Quebec,has ScotiaCard_XBY9"                           |
      | "4482_DNS=Y,PRIM_PROV_CD=Quebec,has ScotiaCard_XBY9"                               |
