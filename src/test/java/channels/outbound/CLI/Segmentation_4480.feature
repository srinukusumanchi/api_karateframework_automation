@Segmentation_TestData @CLI4480_OutboundSegmentation_TestCases_TestData
Feature: Create test data for Pre-Approved Credit Limit Increase - Segmentation test cases
  ...
  @CreditLimitIncrease @CLI4480_Outbound_Segmentation_TestCases_TestData_odt @4480 @OUTBOUND @VS18076
  Scenario: Pre-Approved Credit Limit Increase - AMEX CLI - Sole_VS18076_4480_OUTBOUND Create test data for Positive Test Cases
    ...
    * table examples
      ...
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,has ScotiaCard_XDY7"                        | acct_num      | ""               | card_Number |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,has ScotiaCard_XDY7_AC_1(LESSER acct_odt)"  | acct_num_One  | scd_num          | ""          |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,has ScotiaCard_XDY7_AC_2(greater acct_odt)" | acct_num_two  | scd_num_one      | ""          |
 ...
 # insert the created Card Number into the CUST_ACCT_RLTNP_DIM sheet
  ...
  @CreditLimitIncrease @CLI4480_Outbound_Segmentation_TestCases_TestData_NoScotiaCard @4480 @OUTBOUND @VS18076
  Scenario Outline: Pre-Approved Credit Limit Increase - AMEX CLI - Sole_VS18076_4480_OUTBOUND Create test data for Positive Test Cases
    * def testId = <TestID>
 ...
 # insert the created Card Number into the CUST_ACCT_RLTNP_DIM sheet
    ...
    * call read('classpath:channels/outbound/ReusableScenarios.feature@ACCT_DIM_Insertion_Database')
    ...
    Examples:
      | TestID                                                  |
      | "4480_DNS=N,PRIM_PROV_CD=Quebec,No ScotiaCard_XDY7"     |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,No ScotiaCard_XDY7" |
      | "4480_DNS=Y,PRIM_PROV_CD=Quebec,No ScotiaCard_XDY7"     |
      | "4480_DNS=Y,PRIM_PROV_CD=Non-Quebec,No ScotiaCard_XDY7" |

  @CreditLimitIncrease @4480_CLI_Outbound_Segmentation @4480 @OUTBOUND @VS18076
  Scenario Outline: Pre-Approved Credit Limit Increase - AMEX CLI - Sole Borrower_VS18076_4480_OUTBOUND Create test data for validating IH field values
    ...
    * call read('classpath:channels/outbound/ReusableScenarios.feature@CUST_ACCT_RLTNP_DIM_Insertion_Database') examples
    ...
    Examples:
      | TestID                                                                             |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL<30Days & MOB>30days_XBV1"   |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL<30Days & MOB is NULL_XBV1"  |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL>30Days & MOB<30days_XBV1"   |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL is NULL & MOB<30days_XBV1"  |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL<30Days & MOB<30days_XBV1"   |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL>30Days & MOB>30days_XBW4"   |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL>30Days & MOB is NULL_XBW4"  |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL is NULL & MOB>30days_XBW4"  |
      | "4480_DNS=N,PRIM_PROV_CD=Non-Quebec,Has ScotiaCard,SOL is NULL & MOB is NULL_XBW4" |
      | "4480_DNS=N,PRIM_PROV_CD=Quebec,has ScotiaCard_XDY7"                               |
      | "4480_DNS=Y,PRIM_PROV_CD=Non-Quebec,has ScotiaCard_XDY7"                           |
      | "4480_DNS=Y,PRIM_PROV_CD=Quebec,has ScotiaCard_XDY7"                               |
