...
Feature: Validate Pre-Approved Credit Limit Increase - AMEX CLI - Sole Borrower-4480 Segmentation test cases
  ...
  @CreditLimitIncrease @CreditLimitIncreaseAmexSoloBorrower_Segmentation_Validation @4480 @AS400 @VS18076
  Scenario Outline: Pre-Approved Credit Limit Increase - AMEX CLI - Sole Borrower_VS18076_4480_AS400 Validate <TestID> for Segmentation test case
