...
#  Book appointment(ALL,DEL,ACT), Customer self service(ALL,DEL,ACT) customer defer(DEC)
  @GICRenewal @GICRenewal_DispositionSuppression_1210 @1210 @AS400 @ET14061
  Scenario Outline: GIC Renewal_ET14061_1210_AS400 Validate <TestID> suppression logic for dispositions
...
#    request (Karate keyword) for sending request string
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                                              |
      | "1210_Perform Accept Disposition and offer should not display when Lead scope - ALL"                |
      | "1210_Perform Accept Disposition and offer should not display when Lead scope - ACT"                |
      | "1210_Perform Accept Disposition and offer should not display when Lead scope - DEC"                |
      | "1210_Perform Decline Disposition and offer should not display when Lead scope - ACT"               |
      | "1210_Perform Refer to other team Disposition and offer should not display when Lead scope - DEC"   |
      | "1210_Perform Refer to Sales Disposition and offer should not display when Lead scope - DEC"        |
      | "1210_Perform Book appointment Disposition and offer should not display when Lead scope - ALL"      |
      | "1210_Perform Book appointment Disposition and offer should not display when Lead scope - ACT"      |
      | "1210_Perform Book appointment Disposition and offer should not display when Lead scope - DEC"      |
      | "1210_Perform Customer Self Service Disposition and offer should not display when Lead scope - ALL" |
      | "1210_Perform Customer Self Service Disposition and offer should not display when Lead scope - ACT" |
      | "1210_Perform Customer Self Service Disposition and offer should not display when Lead scope - DEC" |
      | "1210_Perform Customer Defer Disposition and offer should not display when Lead scope - DEC"        |


    # Decline (ALL,DEC), Refer to other team(ALL,ACT), Refer to sales (ALL,ACT), Customer Defer(ALL,ACT)
  @GICRenewal @GICRenewal_DispositionDisplay_1210 @1210 @AS400 @ET14061
  Scenario Outline: GIC Renewal_ET14061_1210_AS400 Validate <TestID> display logic for dispositions
...
#    request (Karate keyword) for sending request string
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                                         |
      | "1210_Perform Decline Disposition and offer should display when Lead scope - ALL"              |
      | "1210_Perform Decline Disposition and offer should display when Lead scope - DEC"              |
      | "1210_Perform Refer to other team Disposition and offer should display  when Lead scope - ALL" |
      | "1210_Perform Refer to other team Disposition and offer should display when Lead scope - ACT"  |
      | "1210_Perform Refer to Sales Disposition and offer should display when Lead scope - ALL"       |
      | "1210_Perform Refer to Sales Disposition and offer should display when Lead scope - ACT"       |
      | "1210_Perform Customer Defer Disposition and offer should display when Lead scope - ALL"       |
      | "1210_Perform Customer Defer Disposition and offer should display when Lead scope - ACT"       |