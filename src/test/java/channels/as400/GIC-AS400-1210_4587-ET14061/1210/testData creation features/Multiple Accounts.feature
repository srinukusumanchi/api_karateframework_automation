...
Feature: Create test data for AS400 - GIC Positive and Negative test cases
  ...
  @GIC_AS400 @GIC_AS400_Positive_TestCases_TestData @GIC_AS400_TwoAccountsTestData_1210 @GIC_AS400_MultipleAccounts @1210 @4587 @NOVA @ET14061
  Scenario Outline: GIC_AS400 Create test data for Two Accounts Positive Test Cases Of 1210
  ...
  @GIC_AS400 @GIC_AS400_Positive_TestCases_TestData @GIC_AS400_TwoAccountsTestData_1210 @GIC_AS400_MultipleAccounts_HigheshtMatDt_1210 @1210 @1210 @AS400 @ET14061
  Scenario Outline: GIC_AS400 Create test data for Two Accounts Positive Test Cases Of 1210 for high maturity amount and other least certificates
