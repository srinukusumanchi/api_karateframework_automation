@PositiveNegative_Validation_5571
Feature: Validate PA Credit Cards-5571 Positive and Negative test cases
  ...
  @PACC @PACC_ValueFeeVisa_Positive_TestCases_Validation @5571 @AS400 @OP14037
  Scenario Outline: PA Credit Cards_OP14037_5571_AS400 Validate <TestID> Positive TestCases Response Fields
...
#    * clearResultFields()
  ...
  @PACC @PACC_ValueFeeVisa_Negative_TestCases_Validation @5571 @AS400 @OP14037
  Scenario Outline: PA Credit Cards_Momentum Infinite_OP14037_5571_AS400 Validate <TestID> Negative TestCases Response Fields
    * def testDataFileName = PACCTestDataAS400FileName
    #    Reading data from Excel sheet
    * def data = ReadValueFromTestData("TestID",<TestID>,testDataLocation,testDataFileName,testDataSheetName);
