@PA_CC_PositiveAndNegative_TestData_4354_AS400
Feature: Create test data for PA_CC-4354 AS400 Positive and Negative test cases
  ...
  @PACCAS400 @PA_CC_AS400_TestData_4354 @4354 @OP14037 @WithOutCustInsights
  Scenario Outline: PA CC_OP14037_4354_AS400 Create test data for Positive Test Cases Without Cust Insights
  ...
  # insert the created CID into the PA_CCUL_CUSTOMER database
    * call read('classpath:channels/as400/ReusableScenarios.feature@PA_CCUL_CUSTOMER_Insertion_Database')
    ...
    Examples:
      ...
      | "N-4354_AS400_offer should not return 5 days before file delivery date in scheduler table"                               |
      ...
      | "4354_AS400_Customer Defer_Disposition"                                                                                  |
      | "4354_AS400_Customer Self-Serve_Disposition"                                                                             |
      | "4354_AS400_Refer to Other Team_Disposition"                                                                             |
      | "4354_AS400_Refer to Sales_Disposition"                                                                                  |
      | "4354_AS400_Book Appointment_Disposition"                                                                                |
      | "4354_AS400_Decline_Disposition"                                                                                         |
      | "4354_AS400_Accept_Disposition"                                                                                          |
      | "4354_AS400_Control_Y"                                                                                                   |
