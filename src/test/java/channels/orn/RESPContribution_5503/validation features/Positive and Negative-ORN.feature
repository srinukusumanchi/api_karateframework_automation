...
Feature: Validate RESP Contribution Positive and Negative for ORN test cases
  ...
  @RESPContribution_5503 @RESPContribution_5503_ORN_Positive_IH_Validation @5503 @ORN  @AUT0TESTTOTAL#35
  Scenario Outline: RESP Contribution_5503_ORN Validate <TestID> Positive TestCases Response and IH Fields
...
#     Validationg IPT and PST records which are recorded in IH
  ...
  @RESPContribution_5503 @RESPContribution_5503_ORN_Positive_Validation @5503 @ORN  @AUT0TESTTOTAL#35
  Scenario Outline: RESP Contribution_5503_ORN Validate <TestID> Positive TestCases Response Fields
...
#    Clear IH when it goes to control group
  ...
  @RESPContribution_5503 @RESPContribution_5503_ORN_NegativeTestCases_Validation @5503 @ORN @RS21096  @AUTUTESTTOTAL#32
  Scenario Outline: RESPContribution_5503_ORN Validate <TestID> Negative TestCases Response Fields
  #    Reading data from Excel sheet
    * def testDataFileName = RESPContributionORNTestData
