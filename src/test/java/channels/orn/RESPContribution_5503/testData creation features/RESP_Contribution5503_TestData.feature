@RESP_Contribution_PosNeg_ORN_5503
Feature: Create test data for RESP Contribution-5503 ORN Positive and Negative test cases
  ...
  @RESPContribution_ORN_Positive_Negative_TestdataCreation @5503 @ORN @RS21096
  Scenario Outline: RESP Contribution_RS21096_5503_ORN Create test data for positive negative test cases

    # Reading testId from Example section
    * def testId = <TestID>
    * print  "Test ID is "+testId

    * def testDataFileName = RESPContributionORNTestData
  ...
  @RESPContribution_Multiple_Insights_ORN @5503 @ORN @RS21096
  Scenario Outline: RESP Contribution_RS21096_5503_ORN Create test data for multiple insights
  ...
  @RESPContribution_multiple_Accts_ORN @5503 @ORN @RS21096
  Scenario Outline: RESP Contribution_RS21096_5503_ORN Create test data for multiple accounts
    ...
    * table custInsightsEx
    ...
    # insert the created CID into the CUST_INSIGHTS sheet
    * call read('classpath:channels/orn/ReusableScenarios.feature@CID_Insertion_CUST_INSIGHTS_Sheet') custInsightsEx
    # insert the created CID  into the CUST_INSIGHTS_DIM database
    * call read('classpath:channels/orn/ReusableScenarios.feature@CUST_INSIGHTS_Insertion_Database') custInsightsEx
