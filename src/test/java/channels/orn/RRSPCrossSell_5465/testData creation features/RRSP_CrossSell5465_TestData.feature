@RRSP_CrossSell_ORN_5465
Feature: Create test data for RRSP Cross Sell-5465 ORN Disposition and Suppression test cases
  ...
  @RRSPCrossSell_Positive_negative_ORN_single_account_TestData_Load @5465 @ORN @RS21093 @11111_RRSP
  Scenario Outline: RRSP Cross Sell_RS21093_5465_ORN Create test data for positive and negative single account
  ...
  # insert the created Account Number into the ACCT_DIM sheet
    ...
    * call read('classpath:channels/orn/ReusableScenarios.feature@CUST_INSIGHTS_Insertion_Database')
    ...
    Examples:
      ...
      | "N-5465_CUST_OPNT_DT < 90 days"                                                                                                                                   | "100"    | "89"         |
      ...
      | "N-5465_ACCT_ODT < 90 Days"                                                                                                                                       | "89"    | "100"         |
  ...
  @RRSPCrossSell_ORN_Test_Data_Load_multiple_accounts @5465 @ORN @RS21093
  Scenario Outline: RRSP Cross Sell_RS21093_5465_ORN Create test data for multiple accounts
  ...
  @RRSPCrossSell_ORN_two_insights_testdata_Load @5465 @ORN @RS21093 
  Scenario Outline: RRSP Cross Sell_RS21093_5465_ORN Create test data with 2 insights
  ...
  @RRSPCrossSell_ORN_three_insights_testdata_Load @5465 @ORN @RS21093
  Scenario Outline: RRSP Cross Sell_RS21093_5465_ORN Create test data for 3 insights
  ...
  @RRSPXsell_ORN_Single_record_ExternalTable_Positive_Negative_Scenarios_TestData @5465 @ORN @RS21093
  Scenario Outline: RRSPXSell_RS21091_5465_ORN_TestData <TestID> Create test data for single account with External table positive and negative scenarios
...
###To add into External input table
    ...
    * call read('classpath:channels/orn/ReusableScenarios.feature@EXTERNAL_INPUT_FILE_LAYOUT_Insertion_Database')
    ...
    Examples:
      ...
      | "5465_ORN_VALID_START_DATE_lt_Curr_Dt"         | 1                | -5             | 100          | 60                | 60                | 50       |
      | "5465_ORN_VALID_START_DATE_eq_Curr_Dt"         | 0                | -5             | 100          | 60                | 60                | 100      |
      | "5465_ORN_VALID_END_DATE_gt_Curr_Dt"           | 5                | -1             | 100          | 60                | 60                | 70       |
      | "5465_ORN_VALID_END_DATE_eq_Curr_Dt"           | 5                | 0              | 100          | 60                | 60                | "NULL"   |
      | "N_5465_ORN_VALID_START_DATE_gt_Curr_Dt"       | -1               | -5             | 100          | 60                | 60                | 50       |
      | "N_5465_ORN_VALID_END_DATE_lt_Curr_Dt"         | 5                | 1              | 100          | 60                | 60                | 50       |
      | "N_5465_ORN_CAMPAIGN_CODE_ne_RS21093"          | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5465_ORN_Seg_CAMPAIGN_CELL_CODE_ne_CIE5465" | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5465_ORN_Seg_CAMPAIGN_CELL_CODE_eq_NULL"    | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5465_ORN_CAMPAIGN_CELL_CODE_FLAG_ne_Y"      | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5465_ORN_CAMPAIGN_CELL_CODE_FLAG_eq_NULL"   | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5465_ORN_ORN_CHANNEL_ne_Y"                  | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5465_ORN_ORN_CHANNEL_eq_NULL"               | 5                | -5             | 100          | 60                | 60                | 50       |

  @RRSPXsell_ORN_multiple_record_ExternalTable_Positive_Negative_Scenarios_TestData @5465 @ORN @RS21093
  Scenario Outline: RRSPXSell_RS21091_5465_ORN_TestData <TestID> Create test data for multiple record with External table
  ...
  # Used table keyword to iterate for any BDD line
    ...
    * call read('classpath:channels/orn/ReusableScenarios.feature@EXTERNAL_INPUT_FILE_LAYOUT_Insertion_Database') examples
    ...
    Examples:
      ...
      | "5465_ORN_multiple_Externaltbl_Records" | 1                 | -5             | 100          | 4                 | 60                | 50       |
