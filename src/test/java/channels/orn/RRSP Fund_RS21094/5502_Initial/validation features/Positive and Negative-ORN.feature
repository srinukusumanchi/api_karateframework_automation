...
Feature: Validate RRSP Fund Positive and Negative for ORN test cases
  ...
  @RRSPFund_5502  @RRSPFund_5502_ORN_IH_Positive_Validation @5502 @ORN @RS21094  @AUTOTESTTOTAL#42
  Scenario Outline: RRSP Fund_5502_ORN Validate <TestID> Positive TestCases Response Fields and IH
...
#     Validating IPT and PST records which are recorded in IH
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      ...
      | "5502_CUST_INSIGHTS.INSIGHT_CD = FLG_PAYROLL_INCREASE and CUST_INSIGHTS.CURR_VAL = 1 OR CUST_INSIGHTS.INSIGHT_CD = FLG_RRSP_OUT_PAYMENT  and CUST_INSIGHTS.CURR_VAL = 1 OR CUST_INSIGHTS.INSIGHT_CD = CNT_PAGEVISIT_RRSP and CUST_INSIGHTS.CURR_VAL < 1" |
      | "5502_ORN_VALID_START_DATE_lt_Curr_Dt"                                                                                                                                                                                                                  |
      | "5502_ORN_VALID_START_DATE_eq_Curr_Dt"                                                                                                                                                                                                                  |
      | "5502_ORN_multiple_Externaltbl_Records"                                                                                                                                                                                                                 |



  @RRSPFund_5502  @RRSPFund_5502_ORN_Positive_Validation @5502 @ORN @RS21094  @AUTOTESTTOTAL#42
  Scenario Outline: RRSP Fund_5502_ORN Validate <TestID> Positive TestCases Response Fields
...
#Added for June 8th 2023 release
      | "5502_ORN_VALID_END_DATE_gt_Curr_Dt"                                                                                                                                                                                                                    |
      | "5502_ORN_VALID_END_DATE_eq_Curr_Dt"                                                                                                                                                                                                                    |


  @RRSPFund_5502 @RRSPFund_5502_ORN_NegativeTestCases_Validation @5502 @ORN @RS21094  @AUTOTESTTOTAL#37
  Scenario Outline: RRSP  Fund_5502_ORN Validate <TestID> Negative TestCases Response Fields
  #    Reading data from Excel sheet
    * def testDataFileName = RRSPFundORNTestData
...
#Added for June 8th 2023 Release
      | "N_5502_ORN_VALID_START_DATE_gt_Curr_Dt"                                                  |
      | "N_5502_ORN_VALID_END_DATE_lt_Curr_Dt"                                                    |
      | "N_5502_ORN_CAMPAIGN_CODE_ne_RS21094"                                                     |
      | "N_5502_ORN_Seg_CAMPAIGN_CELL_CODE_ne_CIE5502"                                            |
      | "N_5502_ORN_Seg_CAMPAIGN_CELL_CODE_eq_NULL"                                               |
      | "N_5502_ORN_CAMPAIGN_CELL_CODE_FLAG_ne_Y"                                                 |
      | "N_5502_ORN_CAMPAIGN_CELL_CODE_FLAG_eq_NULL"                                              |
      | "N_5502_ORN_ORN_CHANNEL_ne_Y"                                                            |
      | "N_5502_ORN_ORN_CHANNEL_eq_NULL"                                                         |
