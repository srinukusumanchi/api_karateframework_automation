...
Feature: Validate TFSA CrossSell Positive and Negative for ORN test cases
  ...
  @TFSACrossSell_5464 @TFSACrossSell_5464_ORN_Positive_IH_Validation @5464 @ORN @RS21091  @AUTOTESTTOTAL#1
...
#     Validationg IPT and PST records which are recorded in IH
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      ...
      | "5464_CUST_INSIGHTS.INSIGHT_CD = FLG_PAYROLL_INCREASE and CUST_INSIGHTS.CURR_VAL ! = 1 OR CUST_INSIGHTS.INSIGHT_CD = CNT_PAGEVISIT_TFSA and CUST_INSIGHTS.CURR_VAL => 1"                                                                                 |
      | "5464_CUST_INSIGHTS.INSIGHT_CD = FLG_PAYROLL_INCREASE and CUST_INSIGHTS.CURR_VAL = 1 OR CUST_INSIGHTS.INSIGHT_CD = FLG_TFSA_OUT_PAYMENT and CUST_INSIGHTS.CURR_VAL = 1 OR CUST_INSIGHTS.INSIGHT_CD = CNT_PAGEVISIT_TFSA and CUST_INSIGHTS.CURR_VAL => 1" |
      | "5464_ORN_VALID_END_DATE_eq_Curr_Dt"                                                                                                                                                                                                                     |
      | "5464_ORN_multiple_Externaltbl_Records"                                                                                                                                                                                                                  |

  @TFSACrossSell_5464 @TFSACrossSell_5464_ORN_Positive_Validation @5464 @ORN @RS21091  @AUTOTESTTOTAL#40
  Scenario Outline: TFSA Cross Sell_5464_ORN Validate <TestID> Positive TestCases Response Fields
  ...
  #    Printing response body in console
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      ...
      | "5464_ORN_VALID_START_DATE_lt_Curr_Dt"                                                                                                                                                                    |
      | "5464_ORN_VALID_START_DATE_eq_Curr_Dt"                                                                                                                                                                    |
      | "5464_ORN_VALID_END_DATE_gt_Curr_Dt"                                                                                                                                                                      |


  @TFSACrossSell_5464 @TFSACrossSell_5464_ORN_NegativeTestCases_Validation @5464 @ORN @RS21091  @AUTOTESTTOTAL#28
  Scenario Outline: TFSACrossSell_5464_ORN Validate <TestID> Negative TestCases Response Fields
  #    Reading data from Excel sheet
    * def testDataFileName = TFSACrossSellORNTestData
  ...
  #    Printing response body in console
    ...
    * assert (responseStringActual == {})|| (responseStringActual != offerCode)
    ...
    Examples:
      ...
      | "N_5464_ORN_VALID_START_DATE_gt_Curr_Dt"                                                   |
      | "N_5464_ORN_VALID_END_DATE_lt_Curr_Dt"                                                     |
      | "N_5464_ORN_CAMPAIGN_CODE_ne_RS21091"                                                      |
      | "N_5464_ORN_Seg_CAMPAIGN_CELL_CODE_ne_CIE5464"                                             |
      | "N_5464_ORN_Seg_CAMPAIGN_CELL_CODE_eq_NULL"                                                |
      | "N_5464_ORN_CAMPAIGN_CELL_CODE_FLAG_ne_Y"                                                  |
      | "N_5464_ORN_CAMPAIGN_CELL_CODE_FLAG_eq_NULL"                                               |
      | "N_5464_ORN_ORN_CHANNEL_ne_Y"                                                              |
      | "N_5464_ORN_ORN_CHANNEL_eq_NULL"                                                           |
