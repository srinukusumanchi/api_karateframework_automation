@CIMCAMP-418  @Dispositions_Validation_5747
Feature: Validate D2DXsell-5747 Disposition and Suppression test cases
...
#Accepted Complete
  @D2DXsell @D2DXsell-5747_DispositionSuppression @5747 @NOVA @RS22054
  Scenario Outline: D2DXsell_RS22054_5747_NOVA Validate <TestID> suppression logic for dispositions
...
#
#    * call read('classpath:channels/nova/ReusableScenarios.feature@CLIDispositionOfferValidationWithIH')
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                                          |
      | "5747_Perform Accepted Complete Disposition and offer should not display when Lead scope - ACT" |


    # Viewed
  @D2DXsell @D2DXsell_5747_DispositionDisplay @5747 @NOVA @RS22054
  Scenario Outline: D2DXsell_RS22054_5747_NOVA Validate <TestID> display logic for dispositions
    * def testDataFileName = D2DXSellNovaTestData
    # Reading data from Excel sheet
...
#    * call read('classpath:channels/nova/ReusableScenarios.feature@CLIDispositionOfferValidationWithIH')
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                           |
      | "5747_Perform Viewed Disposition and offer should display when Lead scope - ACT" |