...
Feature: Validate Pre-Approved Credit Limit Increase - VISA CLI - Sole Borrower-4480 Positive and Negative for ORN test cases
  ...
  @CreditLimitIncrease @CreditLimitIncreaseAmexSoloBorrower_IH_Validation_4480_ORN @4480 @ORN @VS18076
  Scenario Outline: Pre-Approved Credit Limit Increase - AMEX CLI - Sole Borrower_VS18076_4480_ORN Validate <TestID> IH field values against proposition data
...
#    * call read('classpath:channels/orn/ReusableScenarios.feature@reportDbRecords')
  ...
  @CreditLimitIncrease @Pre-ApprovedCreditLimitIncreaseAmexCLISoleBorrower_Positive_TestCases_Validation_4480_ORN @4480 @ORN @VS18076
  ...
  @CreditLimitIncrease @Pre-ApprovedCreditLimitIncreaseAmexCLISoleBorrower_Negative_TestCases_Validation_4480_ORN @4480 @ORN @VS18076
  Scenario Outline: Pre-Approved Credit Limit Increase - AMEX CLI - Sole Borrower_VS18076_4480_ORN Validate <TestID> Negative TestCases Response Fields
    * def testDataFileName = CLItestDataFileName
  #    Reading data from Excel sheet
    * def data = ReadValueFromTestData("TestID",<TestID>,testDataLocation,testDataFileName,testDataSheetName);
