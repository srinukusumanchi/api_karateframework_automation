@CIMCAMP-418 @Segmentation_4479
Feature: Validate Pre-Approved Credit Limit Increase - VISA CLI - Sole Borrower-4479 Segmentation test cases or ORN channel
  ...
  @CreditLimitIncrease @Pre-ApprovedCreditLimitIncreaseVISACLISoleBorrower_Segmentation_TestCases_Validation_ORN @4479 @ORN @VS18076
