@Segmentation_TestData_4479_ORN
Feature: Create test data for Pre-Approved Credit Limit Increase - VISA CLI - Segmentation test cases for ORN channel
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_N_Prov_Y_ScotiaCard_Y_SOL<30_MOB>30_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N, Prov_Y, ScotiaCard_Y, SOL<30, MOB>30
  ...
  # insert the created CID into the AS400 Test data excel sheet
    ...
    * call read('classpath:channels/orn/ReusableScenarios.feature@SOL_LAST_LOGIN_DT_CUST_DIM_Sheet') examples[0]

       # insert the offer expiry date into the CUST_DIM sheet
    * call read('classpath:channels/orn/ReusableScenarios.feature@MOB_LAST_LOGIN_DT_CUST_DIM_Sheet') examples[0]
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_N_Prov_Y_ScotiaCard_Y_SOL<30_MOB=NULL_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N, Prov_Y, ScotiaCard_Y, SOL<30, MOB=NULL
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_N_Prov_Y_ScotiaCard_Y_SOL>NULL_MOB<30_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N, Prov_Y, ScotiaCard_Y, SOL>NULL, MOB<30
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_N_Prov_Y_ScotiaCard_Y_SOL=NULL_MOB=NULL_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N, Prov_Y, ScotiaCard_Y, SOL=NULL, MOB=NULL
  ...
  # insert the created CID into the AS400 Test data excel sheet
    ...
    * call read('classpath:channels/orn/ReusableScenarios.feature@CID_Insertion_CUST_DIM_Sheet') examples
    # insert the created CID into the cust_dim database
    * call read('classpath:channels/orn/ReusableScenarios.feature@CUST_DIM_Insertion_Database') examples[0]
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_N_Prov_Y_ScotiaCard_Y_SOL>30_MOB>30_1-KS_2-BB_Accounts_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N, Prov_Y, ScotiaCard_Y, SOL>30, MOB>30 for 1 KS account and 2 BB accounts
    * def testDataFileName = CLItestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_Y_Prov_Y_ScotiaCard_Y_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N, Prov_Y, ScotiaCard_Y
    * def testDataFileName = CLItestDataFileName
    # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_Y_Prov_N_ScotiaCard_Y_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_Y, Prov_N, ScotiaCard_Y
    * def testDataFileName = CLItestDataFileName
    # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_N_Prov_Y_ScotiaCard_Y_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N, Prov_Y, ScotiaCard_Y
    * def testDataFileName = CLItestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_N_Prov_N_ScotiaCard_Y_TestData_ORN @4479 @ORN @VS18076
  Scenario: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N, Prov_N, ScotiaCard_Y
    * def testDataFileName = CLItestDataFileName
    # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
  ...
  @CreditLimitIncrease @SegmentationVISASole_DNS_Y_N_Prov_N_ScotiaCard_N_Y_TestData_ORN @4479 @ORN @VS18076
  Scenario Outline: Pre-Approved Credit Limit Increase - VISA CLI - Sole_VS18076_447_ORN Create test data for Segmentation logic DNS_N,Y, Prov_N, ScotiaCard_N,Y
    * def testDataFileName = CLItestDataFileName
    * def testId = <TestID>
