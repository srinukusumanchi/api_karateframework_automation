@TFSA_CrossSell_Nova_5464
Feature: Create test data for TFSA Cross Sell-5464 Nova Disposition and Suppression test cases
  ...
  @TFSACrossSell_Positive_NOVA_11111 @5464 @NOVA @RS21091 @11111
  Scenario Outline: TFSA Cross Sell_RS21091_5464_NOVA Create test data for 11111
...
#      | "N-5464_CUST_OPNT_DT < 90 days"                                                                                                                                                                           | "120"    | "90"         |
#      | "N-5464_CUST_OPNT_DT = 90 days"                                                                                                                                                                           | "121"    | "91"         |
...
#      | "N-5464_ACCT_ODT = 90 Days"                                                                                                                                                                               | "91"     | "123"        |
...
#      | "5464_SRC_ACCT_STAT_CD = NULL"                                                                                                                                                                          | "93"     | "93"         |
  ...
  @TFSACrossSell_NOVA_11221 @5464 @NOVA @RS21091 @11221
  Scenario Outline: TFSA Cross Sell_RS21091_5464_NOVA Create test data for 11221
  ...
  @TFSACrossSell_NOVA_11112 @5464 @NOVA @RS21091 @11112
  Scenario Outline: TFSA Cross Sell_RS21091_5464_NOVA Create test data for 11112
  ...
  @TFSACrossSell_NOVA_11113 @5464 @NOVA @RS21091 @11113
  Scenario Outline: TFSA Cross Sell_RS21091_5464_NOVA Create test data for 11113
  ...
  @TFSAXsell_NOVA_Single_record_ExternalTable_Positive_Negative_Scenarios_TestData @5464 @NOVA @RS21091
  Scenario Outline: TFSAXSell_RS21091_5464_NOVA_TestData <TestID> Create test data for single account with External table positive and negative scenarios
...
###To add into External input table
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@EXTERNAL_INPUT_FILE_LAYOUT_Insertion_Database')
    ...
    Examples:
      ...
      | "5464_NOVA_VALID_START_DATE_lt_Curr_Dt"         | 1                | -5             | 100          | 60                | 60                | 50       |
      | "5464_NOVA_VALID_START_DATE_eq_Curr_Dt"         | 0                | -5             | 100          | 60                | 60                | 100      |
      | "5464_NOVA_VALID_END_DATE_gt_Curr_Dt"           | 5                | -1             | 100          | 60                | 60                | 70       |
      | "5464_NOVA_VALID_END_DATE_eq_Curr_Dt"           | 5                | 0              | 100          | 60                | 60                | "NULL"   |
      | "N_5464_NOVA_VALID_START_DATE_gt_Curr_Dt"       | -1               | -5             | 100          | 60                | 60                | 50       |
      | "N_5464_NOVA_VALID_END_DATE_lt_Curr_Dt"         | 5                | 1              | 100          | 60                | 60                | 50       |
      | "N_5464_NOVA_CAMPAIGN_CODE_ne_RS21091"          | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5464_NOVA_Seg_CAMPAIGN_CELL_CODE_ne_CIE5464" | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5464_NOVA_Seg_CAMPAIGN_CELL_CODE_eq_NULL"    | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5464_NOVA_CAMPAIGN_CELL_CODE_FLAG_ne_Y"      | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5464_NOVA_CAMPAIGN_CELL_CODE_FLAG_eq_NULL"   | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5464_NOVA_NOVA_CHANNEL_ne_Y"                 | 5                | -5             | 100          | 60                | 60                | 50       |
      | "N_5464_NOVA_NOVA_CHANNEL_eq_NULL"              | 5                | -5             | 100          | 60                | 60                | 50       |

  @TFSAXsell_NOVA_multiple_record_ExternalTable_Positive_Negative_Scenarios_TestData @5464 @NOVA @RS21091
  Scenario Outline: TFSAXSell_RS21091_5464_NOVA_TestData <TestID> Create test data for multiple record with External table
  ...
  # Used table keyword to iterate for any BDD line
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@EXTERNAL_INPUT_FILE_LAYOUT_Insertion_Database') examples
    ...
    Examples:
      ...
      | "5464_NOVA_multiple_Externaltbl_Records" | 1                 | -5             | 100          | 4                 | 60                | 50       |
