@PA_CC_PositiveNegative_5570_TestData_NOVA
Feature: Create test data for PA CC-5570 Nova test data creation
  ...
  @PA_CCC_NOVATestData_positive_5570 @5570 @NOVA @OP14037 @WithOutCustInSights
  Scenario Outline: PA_CC_OP14037_5570_NOVA Create test data Without Cust_Insights Sheet
...
##      | "N-5570_NOVA_PA_CCUL_Customer is Blank "                                                                                |
      ...
      | "5570_NOVA_VWD_Disposition"                                                                                             |
      | "5570_NOVA_ACT_Disposition"                                                                                             |
      | "5570_NOVA_ATP_Disposition"                                                                                             |
      | "5570_NOVA_Control_Y"                                                                                                   |
  ...
  @PA_CCC_NOVATestData @5570 @NOVA @OP14037 @WithCustInSights_CC_NOVA_5570
  Scenario Outline: PA_CC_OP14037_5570_NOVA Create test data With Cust_Insights sheet
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@CUST_INSIGHTS_Insertion_Database')
    ...
    Examples:
      | TestID                                                |
      | "5570_NOVA_Abandon Offer"                             |
      | "N-5570_NOVA_Abandon Offer_Disposition_AS400 Accept"  |
      | "N-5570_NOVA_Abandon Offer_Disposition_AS400 Decline" |
      | "N-5570_NOVA_Abandon Offer_Unica Disposition_Accept"  |
      | "N-5570_NOVA_Abandon Offer_Unica Disposition_Decline" |
