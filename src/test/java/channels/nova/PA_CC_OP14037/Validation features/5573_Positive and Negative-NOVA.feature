...
Feature: Validate PA CC Positive and Negative for NOVA test cases
  ...
  @PACC_NOVA_5573  @PACC_NOVA_5573_Positive_Validation @5573 @NOVA @OP14037 @AUTOTESTTOTAL#
  Scenario Outline: PA CC_5573_NOVA Validate <TestID> Positive TestCases Response Fields
  ...
  @PACC_NOVA_5573 @PACC_NOVA_5573_Nova_NegativeTestCases_Validation @5573 @NOVA @OP14037 @AUTOTESTTOTAL#
  Scenario Outline: PA CC_5573_NOVA Validate <TestID> Negative TestCases Response Fields
...
#      | "N-5573_NOVA_PA_CCUL_CUSTOMER.Primary Product Code = VCL && PA_CCUL_CUSTOMER.Primary Sub Product Code = NULL"           |
#      | "N-5573_NOVA_PA_CCUL_CUSTOMER.Primary Product Code = NULL && PA_CCUL_CUSTOMER.Primary Sub Product Code = DM"            |
