...
Feature: Validate PA CC Positive and Negative for NOVA test cases
  ...
  @PACC_NOVA_5575  @PACC_NOVA_5575_Positive_Validation @5575 @NOVA @OP14037 @AUTOTESTTOTAL#
  Scenario Outline: PA CC_5575_NOVA Validate <TestID> Positive TestCases Response Fields
  ...
  @PACC_NOVA_5575 @PACC_NOVA_5575_Nova_NegativeTestCases_Validation @5575 @NOVA @OP14037 @AUTOTESTTOTAL#
  Scenario Outline: PA CC_5575_NOVA Validate <TestID> Negative TestCases Response Fields
...
#      | "N-5575_NOVA_PA_CCUL_CUSTOMER.Primary Product Code = NULL && PA_CCUL_CUSTOMER.Primary Sub Product Code = DM"            |
