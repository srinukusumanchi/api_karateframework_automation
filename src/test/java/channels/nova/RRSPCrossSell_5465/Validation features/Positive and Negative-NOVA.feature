...
Feature: Validate RRSP CrossSell Positive and Negative for NOVA test cases
  ...
  @RRSPCrossSell_5465 @RRSPCrossSell_5465_Nova_Positive_IH_Validation @5465 @NOVA @RS21093  @AUTOTESTTOTAL#1
  Scenario Outline: RRSP Cross Sell_5465_NOVA Validate <TestID> IH for Positive TestCases
...
#     Validationg IPT and PST records which are recorded in IH
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                                                                                                                                                                                                   |
      | "5465_NOVA_multiple_Externaltbl_Records"                                                                                                                                                                                                                 |
      | "5465_NOVA_VALID_END_DATE_eq_Curr_Dt"                                                                                                                                                                                                                    |

  @RRSPCrossSell_5465 @RRSPCrossSell_5465_Nova_Positive_Validation @5465 @NOVA
  Scenario Outline: RRSP Cross Sell_5465_NOVA Validate <TestID> Positive TestCases Response Fields
  ...
  #    Printing response body in console
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      ...
      | "5465_NOVA_VALID_START_DATE_lt_Curr_Dt"  |
      | "5465_NOVA_VALID_START_DATE_eq_Curr_Dt"  |
      | "5465_NOVA_VALID_END_DATE_gt_Curr_Dt"    |



  @RRSPCrossSell_5465 @RRSPCrossSell_5465_Nova_NegativeTestCases_Validation @5465 @NOVA @RS21097 @AUTOTESTTOTAL#30
  Scenario Outline: RRSPCrossSell_5465_NOVA Validate <TestID> Negative TestCases Response Fields
  #    Reading data from Excel sheet
    * def testDataFileName = RRSPCrossSellNovaTestData
    ...
    * assert (responseStringActual == {})|| (responseStringActual != offerCode)
    ...
    Examples:
      ...
      | "N-5465_PLN_ACCT_CD_MASTER = RRSP and ACCT_SUBSYS_ID = UF and SRC_ACCT_STAT_CD = Active"   |
           ...
           # Added for Mar 25 2023 - External Table
      | "N_5465_NOVA_VALID_START_DATE_gt_Curr_Dt"                                                   |
      | "N_5465_NOVA_VALID_END_DATE_lt_Curr_Dt"                                                     |
      | "N_5465_NOVA_CAMPAIGN_CODE_ne_RS21093"                                                      |
      | "N_5465_NOVA_Seg_CAMPAIGN_CELL_CODE_ne_CIE5465"                                             |
      | "N_5465_NOVA_Seg_CAMPAIGN_CELL_CODE_eq_NULL"                                                |
      | "N_5465_NOVA_CAMPAIGN_CELL_CODE_FLAG_ne_Y"                                                  |
      | "N_5465_NOVA_CAMPAIGN_CELL_CODE_FLAG_eq_NULL"                                               |
      | "N_5465_NOVA_NOVA_CHANNEL_ne_Y"                                                              |
      | "N_5465_NOVA_NOVA_CHANNEL_eq_NULL"                                                           |
