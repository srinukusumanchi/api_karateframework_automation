@Dispositions_Validation_NOVA_4893
Feature: Validate Cross Sell BBA_BBP-4893 Disposition and Suppression test cases
...
#Accepted Complete
  @D2DCrossSell @CrossSellBBA_BBP_DispositionSuppression @4893 @NOVA @RS19067
  Scenario Outline: Cross Sell BBA_BBP_RS19067_4893_NOVA Validate <TestID> suppression logic for dispositions
...
#    Printing request body in console
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                                          |
      | "4893_Perform Accepted Complete Disposition and offer should not display when Lead scope - ACT" |


    # Viewed  #Accept in Progress
  @D2DCrossSell @CrossSellBBA_BBP_DispositionDisplay @4893 @NOVA @RS19067
  Scenario Outline: Cross Sell BBA_BBP_RS19067_4893_NOVA Validate <TestID> display logic for dispositions
    * def testDataFileName = CrossSellNOVAtestDataFileName
      # Reading data from Excel sheet
...
#    Printing request body in console
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                           |
      | "4893_Perform Viewed Disposition and offer should display when Lead scope - ACT" |
      | "4893_Perform Accepted In Progress Disposition and offer should display when Lead scope - ACT" |