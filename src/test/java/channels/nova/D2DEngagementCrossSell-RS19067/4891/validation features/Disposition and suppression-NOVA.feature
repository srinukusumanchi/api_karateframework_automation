@Dispositions_Validation_NOVA_4891
Feature: Validate Cross Sell Ultimate-4891 Disposition and Suppression test cases
...
#Accepted Complete
  @D2DCrossSell @CrossSellULTIMATE_DispositionSuppression @4891 @NOVA @RS19067
  Scenario Outline: Cross Sell Ultimate_RS19067_4891_NOVA Validate <TestID> suppression logic for dispositions
...
#    Printing request body in console
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                                          |
      | "4891_Perform Accepted Complete Disposition and offer should not display when Lead scope - ACT" |


    # Viewed  #Accept in Progress
  @D2DCrossSell @CrossSellULTIMATE_DispositionDisplay @4891 @NOVA @RS19067
  Scenario Outline: Cross Sell Ultimate_RS19067_4891_NOVA Validate <TestID> display logic for dispositions
    * def testDataFileName = CrossSellNOVAtestDataFileName
      # Reading data from Excel sheet
...
#    Printing request body in console
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                           |
      | "4891_Perform Viewed Disposition and offer should display when Lead scope - ACT" |
      | "4891_Perform Accepted In Progress Disposition and offer should display when Lead scope - ACT" |