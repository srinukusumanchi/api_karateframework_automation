@Dispositions_Validation_NOVA_4892
Feature: Validate Cross Sell SCOTIAONE-4892 Disposition and Suppression test cases
...
#Accepted Complete
  @D2DCrossSell @CrossSellSCOTIAONE_DispositionSuppression @4892 @NOVA @RS19067
  Scenario Outline: Cross Sell SCOTIAONE_RS19067_4892_NOVA Validate <TestID> suppression logic for dispositions
...
#    Printing request body in console
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                                          |
      | "4892_Perform Accepted Complete Disposition and offer should not display when Lead scope - ACT" |


    # Viewed  #Accept in Progress
  @D2DCrossSell @CrossSellSCOTIAONE_DispositionDisplay @4892 @NOVA @RS19067
  Scenario Outline: Cross Sell SCOTIAONE_RS19067_4892_NOVA Validate <TestID> display logic for dispositions
    * def testDataFileName = CrossSellNOVAtestDataFileName
      # Reading data from Excel sheet
...
#    Printing request body in console
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                           |
      | "4892_Perform Viewed Disposition and offer should display when Lead scope - ACT" |
      | "4892_Perform Accepted In Progress Disposition and offer should display when Lead scope - ACT" |