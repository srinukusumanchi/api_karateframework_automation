...
Feature: Validate Pre-Approved Credit Limit Increase - AMEX CLI - Sole Borrower-4480 Segmentation test cases
  ...
  Background: Common for NOVA Segmentation
  ...
  @CreditLimitIncrease @Pre-ApprovedCreditLimitIncreaseAMEXCLISoleBorrower_Segmentation_TestCases_Validation @4480 @NOVA @VS18076
