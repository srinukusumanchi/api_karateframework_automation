...
Feature: Validate GIC Renewal-4587 Disposition and Suppression test cases
  ...
  # Reading common functions feature file
    ...
    * def requestfile = read('classpath:channels/nova/ChannelNOVA.txt')
    ...
    #Accepted Complete
    # Viewed
  @GICRenewal @GICRenewal_DispositionDisplay_NOVA_4587 @4587 @NOVA @ET14061
  Scenario Outline: GIC Renewal_ET14061_4587_NOVA Validate <TestID> display logic for dispositions
...
#    * call read('classpath:channels/nova/ReusableScenarios.feature@GICContextualOfferValidation_NOVA')
  ...
  #    Verifying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                                |
      | "4587_Perform Accept Completed Disposition and offer should display when Lead scope - ACT" |
      | "4587_Perform Viewed Disposition and offer should display when Lead scope - ACT"           |
