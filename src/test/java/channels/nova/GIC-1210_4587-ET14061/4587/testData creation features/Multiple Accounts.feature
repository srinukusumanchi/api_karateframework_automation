...
Feature: Create test data for NOVA - GIC Renewal Investments Positive and Negative test cases
  ...
  @GICTestData_NOVA @GIC_NOVA_Positive_TestCases_TestData @GIC_NOVATwoAccountsTestData_4587 @GIC_NOVA_MultipleAccounts @4587 @4587 @NOVA @ET14061
  Scenario Outline: GIC Renewal Investments_NOVA Create test data for Two Accounts Positive Test Cases Of 4587
  ...
  @GIC_NOVA @GIC_NOVA_Positive_TestCases_TestData @GIC_NOVA_TwoAccountsMULTITestData_4587 @GIC_NOVA_MultipleAccounts_HigheshtMatValAmt_4587 @4587 @4587 @NOVA @ET14061
  Scenario Outline: GIC_NOVA Create test data for Two Accounts Positive Test Cases Of 4587 for high maturity amount and other least certificates
