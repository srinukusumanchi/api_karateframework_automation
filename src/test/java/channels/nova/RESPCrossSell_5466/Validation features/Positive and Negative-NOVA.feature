...
Feature: Validate RESP CrossSell Positive and Negative for NOVA test cases
  ...
  @RESPCrossSell_5466 @RESPCrossSell_5466_Nova_Positive_Validation @5466 @NOVA  @AUT0TESTTOTAL#43
  Scenario Outline: RESP Cross Sell_5466_NOVA Validate <TestID> Positive TestCases Response Fields
...
#      | "5466_SRC_ACCT_STAT_CD = NULL"                                                                                            |
  ...
  @RESPCrossSell_5466 @RESPCrossSell_5466_Nova_NegativeTestCases_Validation @5466 @NOVA @RS21097  @AUTUTESTTOTAL#27
  Scenario Outline: RESPCrossSell_5466_NOVA Validate <TestID> Negative TestCases Response Fields
  #    Reading data from Excel sheet
    * def testDataFileName = RESPCrossSellNovaTestData
