...
Feature: Create test data for MPSA Welcome Bonus 5839 offer positive nd negative scenarios
  ...
  @MPSAWelcomeBonus @MPSAWelcomeBonus_Base_TestData @5839 @NOVA @RS22116 @Sanity-NOVA
  Scenario Outline: MPSA Welcome Bonus_RS22116_5839_NOVA Create test data for base test case
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@CUST_INSIGHTS_Insertion_Database')
    ...
    Examples:
      | TestID              | ACCT_ODT |
      | "5839_NOVA_BASE_01" | "20"     |


  @MPSAWelcomeBonus @MPSAWelcomeBonus_Positive_TestData @5839 @NOVA @RS22116
  Scenario Outline: MPSA Welcome Bonus_RS22116_5839_NOVA Create test data for Positive Scenarios
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@CUST_INSIGHTS_Insertion_Database')
    ...
    Examples:
      | TestID                                           | ACCT_ODT |
#      | "5839_NOVA_CUST_AGE_eq_18"                       | "20"     |
#      | "5839_NOVA_LANG_CD_eq_fr"                        | "20"     |
#      | "5839_NOVA_NOT_AML_KYC_eq_NULL"                  | "20"     |
#      | "5839_NOVA_MD_FINANCIAL_F_eq_NULL"               | "20"     |
      | "5839_NOVA_ITRADE_MCLEOD_F_eq_NULL"              | "20"     |
#      | "5839_NOVA_DEDICATED_INVSTMNT_ADVISOR_F_eq_NULL" | "20"     |
#      | "5839_NOVA_DO_NOT_SOLICIT_F_eq_NULL"             | "20"     |
#      | "5839_NOVA_ACCT_ODT_eq_30"                       | "30"     |
      | "5839_NOVA_ITRADE_MCLEOD_F_eq_Y"                 | "20"     |


  @MPSAWelcomeBonus @MPSAWelcomeBonus_Negative_TestData @5839 @NOVA @RS22116
  Scenario Outline: MPSA Welcome Bonus_RS22116_5839_NOVA Create test data for Negative Scenarios
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@CUST_INSIGHTS_Insertion_Database')
    ...
    Examples:
      | TestID                                          | ACCT_ODT |
      | "N_5839_NOVA_DECEASED_F_eq_Y"                   | "20"     |
      | "N_5839_NOVA_DECEASED_F_eq_NULL"                | "20"     |
      | "N_5839_NOVA_CUST_TP_CD_ne_PSNL"                | "20"     |
      | "N_5839_NOVA_CUST_TP_CD_eq_NULL"                | "20"     |
      | "N_5839_NOVA_PRIM_CNTRY_CD_ne_CA"               | "20"     |
      | "N_5839_NOVA_PRIM_CNTRY_CD_eq_NULL"             | "20"     |
      | "N_5839_NOVA_CUST_AGE_lt_18"                    | "20"     |
      | "N_5839_NOVA_CUST_AGE_eq_NULL"                  | "20"     |
      | "N_5839_NOVA_LANG_CD_ne_en_fr"                  | "20"     |
      | "N_5839_NOVA_LANG_CD_eq_NULL"                   | "20"     |
      | "N_5839_NOVA_NOT_AML_KYC_eq_Y"                  | "20"     |
      | "N_5839_NOVA_MD_FINANCIAL_F_eq_Y"               | "20"     |
      | "N_5839_NOVA_DEDICATED_INVSTMNT_ADVISOR_F_eq_Y" | "20"     |
      | "N_5839_NOVA_HAS_CLOSED_MPSA_F_eq_Y"            | "20"     |
      | "N_5839_NOVA_HAS_CLOSED_MPSA_F_eq_NULL"         | "20"     |
      | "N_5839_NOVA_MRKTBLE_F_n_eq_Y"                  | "20"     |
      | "N_5839_NOVA_MRKTBLE_F_eq_NULL"                 | "20"     |
      | "N_5839_NOVA_DO_NOT_SOLICIT_F_eq_Y"             | "20"     |
      | "N_5839_NOVA_SRC_ACCT_STAT_CD_ne_Active"        | "20"     |
      | "N_5839_NOVA_SRC_ACCT_STAT_CD_eq_NULL"          | "20"     |
      | "N_5839_NOVA_ACCT_SUBSYS_ID_ne_UF"              | "20"     |
      | "N_5839_NOVA_ACCT_SUBSYS_ID_eq_NULL"            | "20"     |
      | "N_5839_NOVA_SRC_SYS_PRD_CD_ne_BSAMP"           | "20"     |
      | "N_5839_NOVA_SRC_SYS_PRD_CD_eq_NULL"            | "20"     |
      | "N_5839_NOVA_ACCT_ODT_eq_0"                     | "0"      |
      | "N_5839_NOVA_ACCT_ODT_gt_30"                    | "31"     |
      | "N_5839_NOVA_ACCT_ODT_eq_NULL"                  | "NULL"   |
      | "N_5839_NOVA_PRIMARY_ACCT_HOLDER_FLAG_ne_Y"     | "20"     |
      | "N_5839_NOVA_PRIMARY_ACCT_HOLDER_FLAG_eq_NULL"  | "20"     |
      | "N_5839_NOVA_INSIGHT_CD_ne_MPSA_WELCOME_BONUS"  | "20"     |
#      | "N_5839_NOVA_INSIGHT_CD_eq_NULL"                | "20"     | -- cannot be inserted in DB
      | "N_5839_NOVA_CURR_VAL_ne_1"                     | "20"     |
      | "N_5839_NOVA_CURR_VAL_eq_NULL"                  | "20"     |


  @MPSAWelcomeBonus @MPSAWelcomeBonus_MultipleInsights_PosNeg_TestData @5839 @NOVA @RS22116
  Scenario Outline: MPSA Welcome Bonus_RS22116_5839_NOVA Create test data for multiple cust insight Scenarios
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@CUST_INSIGHTS_Insertion_Database') cust_insights
    Examples:
      | TestID                                                                  | ACCT_ODT |
      | "5839_NOVA_INSIGHT_CD_eq_FLG_MPSA_ACQ_RS22021_CONTROL_CURR_VAL_ne_1"    | "20"     |
      | "5839_NOVA_INSIGHT_CD_eq_FLG_MPSA_ACQ_RS22021_CONTROL_CURR_VAL_eq_NULL" | "20"     |
      | "5839_NOVA_INSIGHT_CD_eq_FLG_MPSA_ACQ_RS22021_TARGET_CURR_VAL_ne_1"     | "20"     |
      | "5839_NOVA_INSIGHT_CD_eq_FLG_MPSA_ACQ_RS22021_TARGET_CURR_VAL_eq_NULL"  | "20"     |
      | "N_5839_NOVA_INSIGHT_CD_eq_FLG_MPSA_ACQ_RS22021_CONTROL_CURR_VAL_eq_1"  | "20"     |
      | "N_5839_NOVA_INSIGHT_CD_eq_FLG_MPSA_ACQ_RS22021_TARGET_CURR_VAL_eq_1"   | "20"     |
