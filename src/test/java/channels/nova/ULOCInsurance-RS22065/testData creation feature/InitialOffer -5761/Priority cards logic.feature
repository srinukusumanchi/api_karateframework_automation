...
#  Priority-1(VLR,RG)  offer returns when Priority 3(VCL,NF) has higher credit limit than Priority 1(VLR,RG)
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-1(VLR,RG) and 3(VCL,NF) cards when Priority-3 has highest credit limit
...
#  Priority-1(VLR,RG)  offer returns when Priority 1(VLR,RG) has higher credit limit than Priority 3(VCL,SV)
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-1(VLR,RG) and 3(VCL,SV) cards when Priority-1 has highest credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
...
#  Priority-1(VLR,RG)  offer returns when Priority 1(VLR,RG) and 3(VGD,NF) has equal credit limit
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-1(VLR,RG) and 3(VGD,NF) cards when Priority-1&3 has equal credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
  ...
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-2(VLR,NF) and 3(VGD,RG) cards when Priority-3 has highest credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
    # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
...
#  Priority-2(VLR,NF)  offer returns when Priority 2(VLR,NF) has higher credit limit than Priority 3(VGD,SP) for Account 1
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-2(VLR,NF) and 3(VGD,SP) cards when Priority-2 has highest credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
...
#  Priority-2(VLR,NF)  offer returns when Priority 2(VLR,NF) and 3(VCL,SS) has equal credit limit
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-2(VLR,NF) and 3(VCL,SS) cards when Priority-2&3 has equal credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
...
#-----------------------
  ...
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-1(VLR,RG) and 2(VLR,NF) cards when Priority-2 has highest credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
    # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
...
#  Priority-1(VLR,RG)  offer returns when Priority 1(VLR,RG) has higher credit limit than Priority 2(VLR,NF)
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-1(VLR,RG) and (VLR,NF) cards when Priority-1 has highest credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
...
#  Priority-1(VLR,RG)  offer returns when Priority 1(VLR,RG) and 2(VLR,NF) has equal credit limit
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-1(VLR,RG) and 2(VLR,NF) cards when Priority-1&2 has equal credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
  ...
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-3(VCL,ZZ) and 3(VCL,RG) cards when Priority-3(VCL,ZZ) has highest credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
    # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
...
# Priority-3(AXS,SC) OR (VLR, RC) offer returns when Priority 3(AXS,SC) and  (VLR, RC) has equal credit limit
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-3(AXS,SC) or 3(VLR, RC) offer returns both cards has equal credit limits
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
...
#  Priority-1(VLR,RG) offer returns when Priority 2(VLR,NF) has highest credit limit than Priority 1(VLR,RG) and Priority 3(VFF,TR)
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-1(VLR,RG), 2(VLR,NF) and 3(VFF,TR)cards when Priority-2(VLR,NF) has highest credit limit
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
  ...
  @CreditorInsurance @CreditorInsurance_PriorityCards_TestData @2423 @NOVA @VS17084
  Scenario: Creditor Insurance_VS17084_2423_NOVA Create test data for Priority-1(VLR,RG), 2(VLR,NF) and 3(VFF,TR)cards when Priority-1,2&3 has equal credit limits
    * def testDataFileName = CreditorInsurancetestDataFileName
      # Generate Random cid to insert into database
    * def CID = randGen(15)
    * print  "Random generated CID is "+CID
