...
Feature: Validate Creditor Insurance-2423 Priority cards test cases
  ...
  Background: Common for NOVA Priority Cards logic
  ...
  @CreditorInsurance @CreditorInsurance_PriorityCards @2423 @NOVA @VS17084
  Scenario Outline: Creditor Insurance_VS17084_2423_NOVA Validate <TestID> Response Fields for Priority cards logic
