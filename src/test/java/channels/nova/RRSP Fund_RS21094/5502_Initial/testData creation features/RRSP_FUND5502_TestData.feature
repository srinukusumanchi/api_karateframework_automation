@RRSP_Fund_Nova_5502
Feature: Create test data for RRSP Fund-5502 Nova  test data creation
  ...
  @RRSPFund_NOVA_SingleInsight_Negative_TestData @5502 @NOVA @RS21094
  Scenario Outline: RRSP Fund_RS21094_5502_NOVA Create test data for Single Insight Negative
  ...
  @RRSPFund_NOVA_2_insight_Postive_Negative_TestData @5502 @NOVA @RS21094
  Scenario Outline: RRSP Fund_RS21094_5502_NOVA Create test data for 2 insights Positive and negative
...
#Added for Jan 5th 2023 release
  ...
  @RRSPFund_NOVA_3_Insight_TestData @5502 @NOVA @RS21094
  Scenario Outline: RRSP Fund_RS21094_5502_NOVA Create test data for 3 insights
...
#Added for Jan 5th 2023 release
  ...
  @RRSPFund_NOVA_2_Accounts_TestData @5502 @NOVA @RS21094
  Scenario Outline: RRSP Fund_RS21094_5502_NOVA Create test data for 2 accounts
  ...
  @RRSPFund_NOVA_4_insights_TestData @5502 @NOVA @RS21094
  Scenario Outline: RRSP Fund_RS21094_5502_NOVA Create test data for 4 insights
...
#    Added for June 8th 2023 release for adding external table for inclusion and exclusion for RRSP Contribution offer
  ...
  @RRSPContribution_NOVA_Single_record_ExternalTable_Positive_Negative_Scenarios_TestData @5502 @NOVA @RS21094
  Scenario Outline: RRSPContribution_RS21094_5502_NOVA_TestData <TestID> Create test data for single account with External table positive and negative scenarios
...
###To add into External input table
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@EXTERNAL_INPUT_FILE_LAYOUT_Insertion_Database')
    ...
    Examples:
      ...
      | "5502_NOVA_VALID_START_DATE_lt_Curr_Dt"         | 1                | -5             | 100          | 60                | 60                | 100      |
      | "5502_NOVA_VALID_START_DATE_eq_Curr_Dt"         | 0                | -5             | 100          | 60                | 60                | 100      |
      | "5502_NOVA_VALID_END_DATE_gt_Curr_Dt"           | 5                | -1             | 100          | 60                | 60                | 100      |
      | "5502_NOVA_VALID_END_DATE_eq_Curr_Dt"           | 5                | 0              | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_VALID_START_DATE_gt_Curr_Dt"       | -1               | -5             | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_VALID_END_DATE_lt_Curr_Dt"         | 5                | 1              | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_CAMPAIGN_CODE_ne_RS21094"          | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_Seg_CAMPAIGN_CELL_CODE_ne_CIE5502" | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_Seg_CAMPAIGN_CELL_CODE_eq_NULL"    | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_CAMPAIGN_CELL_CODE_FLAG_ne_Y"      | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_CAMPAIGN_CELL_CODE_FLAG_eq_NULL"   | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_NOVA_CHANNEL_ne_Y"                 | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5502_NOVA_NOVA_CHANNEL_eq_NULL"              | 5                | -5             | 100          | 60                | 60                | 100      |

  @RRSPContribution_NOVA_multiple_record_ExternalTable_Positive_Negative_Scenarios_TestData @5502 @NOVA @RS21094
  Scenario Outline: RRSPContribution_RS21094_5502_NOVA_TestData <TestID> Create test data for multiple record with External table
  ...
  # Used table keyword to iterate for any BDD line
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@EXTERNAL_INPUT_FILE_LAYOUT_Insertion_Database') examples
    ...
    Examples:
      ...
      | "5502_NOVA_multiple_Externaltbl_Records" | 1                 | -5             | 100          | 4                 | 60                | 100      |
