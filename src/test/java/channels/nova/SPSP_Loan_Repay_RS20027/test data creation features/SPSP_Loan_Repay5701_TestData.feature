@SPSP_Loan_Repay_Nova_5701
Feature: Create test data for SPSP_Loan-5701 Nova test data creation
  ...
  @SPSP_Loan_Repay_NOVATestData @5701 @NOVA @RS20027
  Scenario Outline: SPSP_RS20027_5701_NOVA Create test data
  ...
  @SPSP_Loan_Repay_NOVATestData @5701 @NOVA @RS20027 @boundaryStudydate
  Scenario Outline: SPSP_RS20027_5701_NOVA Create test data
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@ACCT_DIM_Insertion_Database')
    ...
    Examples:
      | TestID                                            |Study_End_dt|
      |"5701_NOVA_Current Date - STUDY_END_DT =120 Days"  |120|
      |"5701_NOVA_Current Date - STUDY_END_DT  = 121 Days"|121|
      |"5701_NOVA_Current Date - STUDY_END_DT  =149 Days" |149|
      |"5701_NOVA_Current Date - STUDY_END_DT =150 Days"  |150|
      |"N_5701_NOVA_Current Date - STUDY_END_DT =119 Days"|119|
      |"N_5701_NOVA_Current Date - STUDY_END_DT  = 151 Days"|151|
