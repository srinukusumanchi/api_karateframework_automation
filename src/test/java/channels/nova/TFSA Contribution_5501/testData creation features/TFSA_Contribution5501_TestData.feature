@TFSA_Contribution_Nova_5501
Feature: Create test data for TFSA Contribution-5501 Nova  test data creation
  ...
  @TFSAContribution_NOVA_SingleInsight_TestData @5501 @NOVA @RS21092
  Scenario Outline: TFSA Contribution_RS21092_5501_NOVA Create test data for single insight
  ...
  @TFSAContribution_NOVA_2_Insights_TestData @5464 @NOVA @RS21092
  Scenario Outline: TFSA Contribution_RS21092_5501_NOVA Create test data for2 insights
...
#Added for Jan 5th 2023 release
  ...
  @TFSAContribution_NOVA_3_Insights_TestData @5501 @NOVA @RS21091
  Scenario Outline: TFSA Contribution_RS21092_5501_NOVA Create test data for 3 insights
...
#Added for Jan 5th 2023 release
  ...
  @TFSAContribution_2_accounts_NOVA_TestData @5501 @NOVA @RS21091
  Scenario Outline: TFSA Contribution_RS21092_5501_NOVA Create test data for 2 accounts
  ...
  @TFSAContribution_NOVA_4_Insights_TestData @5501 @NOVA @RS21092
  Scenario Outline: TFSA Contribution_RS21092_5501_NOVA Create test data for 4 insights
...
#    Added for June 8th 2023 release for adding external table for inclusion and exclusion for TFSA Contribution offer
  ...
  @TFSAContribution_NOVA_Single_record_ExternalTable_Positive_Negative_Scenarios_TestData @5501 @NOVA @RS21092
  Scenario Outline: TFSAContribution_RS21092_5501_NOVA_TestData <TestID> Create test data for single account with External table positive and negative scenarios
...
###To add into External input table
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@CUST_INSIGHTS_Insertion_Database')
    ...
    Examples:
      ...
      | "5501_NOVA_VALID_START_DATE_lt_Curr_Dt"         | 1                | -5             | 100          | 60                | 60                | 100       |
      | "5501_NOVA_VALID_START_DATE_eq_Curr_Dt"         | 0                | -5             | 100          | 60                | 60                | 100      |
      | "5501_NOVA_VALID_END_DATE_gt_Curr_Dt"           | 5                | -1             | 100          | 60                | 60                | 100       |
      | "5501_NOVA_VALID_END_DATE_eq_Curr_Dt"           | 5                | 0              | 100          | 60                | 60                | 100   |
      | "N_5501_NOVA_VALID_START_DATE_gt_Curr_Dt"       | -1               | -5             | 100          | 60                | 60                | 100       |
      | "N_5501_NOVA_VALID_END_DATE_lt_Curr_Dt"         | 5                | 1              | 100          | 60                | 60                | 100       |
      | "N_5501_NOVA_CAMPAIGN_CODE_ne_RS21092"          | 5                | -5             | 100          | 60                | 60                | 100       |
      | "N_5501_NOVA_Seg_CAMPAIGN_CELL_CODE_ne_CIE5501" | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5501_NOVA_Seg_CAMPAIGN_CELL_CODE_eq_NULL"    | 5                | -5             | 100          | 60                | 60                | 100       |
      | "N_5501_NOVA_CAMPAIGN_CELL_CODE_FLAG_ne_Y"      | 5                | -5             | 100          | 60                | 60                | 100       |
      | "N_5501_NOVA_CAMPAIGN_CELL_CODE_FLAG_eq_NULL"   | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5501_NOVA_NOVA_CHANNEL_ne_Y"                  | 5                | -5             | 100          | 60                | 60                | 100      |
      | "N_5501_NOVA_NOVA_CHANNEL_eq_NULL"               | 5                | -5             | 100          | 60                | 60                | 100       |

  @TFSAContribution_NOVA_multiple_record_ExternalTable_Positive_Negative_Scenarios_TestData @5501 @NOVA @RS21092
  Scenario Outline: TFSAContribution_RS21092_5501_NOVA_TestData <TestID> Create test data for multiple record with External table
  ...
  # Used table keyword to iterate for any BDD line
    ...
    * call read('classpath:channels/NOVA/ReusableScenarios.feature@EXTERNAL_INPUT_FILE_LAYOUT_Insertion_Database') examples
    ...
    Examples:
      ...
      | "5501_NOVA_multiple_Externaltbl_Records" | 1                 | -5             | 100          | 4                 | 60                | 100       |
