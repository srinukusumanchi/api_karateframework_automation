...
Feature: Validate TFSA Fund Positive and Negative for NOVA test cases
  ...
  @TFSAFund_5501  @TFSAFund_5501_Nova_Positive_IH_Validation @5501 @NOVA @RS21092  @AUTOTESTTOTAL#39
  Scenario Outline: TFSA Fund_5501_IH_NOVA Validate <TestID> Positive TestCases Response Fields with IH validation
...
#     Validating IPT and PST records which are recorded in IH
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      ...
      | "5501_NOVA_VALID_START_DATE_lt_Curr_Dt"                                                                                                                                                                                                                  |
      | "5501_NOVA_VALID_START_DATE_eq_Curr_Dt"                                                                                                                                                                                                                  |
      | "5501_NOVA_multiple_Externaltbl_Records"                                                                                                                                                                                                                 |
  ...
  @TFSAFund_5501  @TFSAFund_5501_Nova_Positive_Validation @5501 @NOVA @RS21092  @AUTOTESTTOTAL#39
  Scenario Outline: TFSA Fund_5501_NOVA Validate <TestID> Positive TestCases Response Fields
...
#Added for June 8th 2023 release
      | "5501_NOVA_VALID_END_DATE_gt_Curr_Dt"                                                                                                                                                                                                                    |
      | "5501_NOVA_VALID_END_DATE_eq_Curr_Dt"                                                                                                                                                                                                                    |

  @TFSAFund_5501 @TFSAFund_5501_Nova_NegativeTestCases_Validation @5501 @NOVA @RS21092  @AUTOTESTTOTAL#36
  Scenario Outline: TFSA Fund_5501_NOVA Validate <TestID> Negative TestCases Response Fields
  #    Reading data from Excel sheet
    * def testDataFileName = TFSAFundNovaTestData
...
#Added for June 8th 2023 Release
      | "N_5501_NOVA_VALID_START_DATE_gt_Curr_Dt"                                                  |
      | "N_5501_NOVA_VALID_END_DATE_lt_Curr_Dt"                                                    |
      | "N_5501_NOVA_CAMPAIGN_CODE_ne_RS21092"                                                     |
      | "N_5501_NOVA_Seg_CAMPAIGN_CELL_CODE_ne_CIE5501"                                            |
      | "N_5501_NOVA_Seg_CAMPAIGN_CELL_CODE_eq_NULL"                                               |
      | "N_5501_NOVA_CAMPAIGN_CELL_CODE_FLAG_ne_Y"                                                 |
      | "N_5501_NOVA_CAMPAIGN_CELL_CODE_FLAG_eq_NULL"                                              |
      | "N_5501_NOVA_NOVA_CHANNEL_ne_Y"                                                            |
      | "N_5501_NOVA_NOVA_CHANNEL_eq_NULL"                                                         |
