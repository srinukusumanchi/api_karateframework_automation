@PositiveAndNegative_NTC_MA_TestData_5152_SOL
Feature: Create test data for NTC MA SOL-5152 Positive and Negative test cases
  ...
  @NTCMortgageAcquisitionSOL @NTCMortgageAcquisitionSOL_5152_Positive_TestData @5152 @SOL @RS2098D
  Scenario Outline: NTC Mortgage Acquisition_RS2098D_5152_SOL Create test data for Positive Test Cases

    # Reading testId from Example section
    * def testId = <TestID>
    * def testDataFileName = NTCMortgageAcquisitionSOLDataFile
  ...
  @NTCMortgageAcquisitionSOL @NTCMortgageAcquisitionSOL_5152_Negative_TestData @5152 @SOL @RS2098D
  Scenario Outline: NTC Mortgage Acquisition_RS2098D_5152_SOL Create test data for Negative Test Cases
  ...
  @NTCMortgageAcquisitionSOL @NTCMortgageAcquisitionSOL_MultipleAccounts_5152_Pos_Neg_TestData @5152 @SOL @RS2098D
  Scenario Outline: NTC Mortgage Acquisition_RS2098D_5152_SOL Create test data for Multiple Accounts Positive And Negative Test Cases
