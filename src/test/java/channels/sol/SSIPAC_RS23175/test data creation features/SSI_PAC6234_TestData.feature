@SSI_PAC_SOL_6234
Feature: Create test data for SSI_PAC_6234 SOL test data creation
  ...
  @SSI_PAC_SOLTestData_1account @6234 @SOL @RS23175 @1account
  Scenario Outline: SSIPAC_RS23175_6234_SOL Create test data
    ...
    * call read('classpath:channels/sol/ReusableScenarios.feature@ACCT_DIM_Insertion_Database')
    ...
    Examples:
      ...
      | "6234_SOL_Creative_01_LANG_CD_eq_EN"                                                                         | "25"     |
      | "6234_SOL_Creative_01_LANG_CD_eq_F"                                                                          | "25"     |
      | "6234_SOL_Creative_01_LANG_CD_eq_FR"                                                                         | "25"     |
      | "6234_SOL_Creative_01_ITRADE_MCLEOD_F_eq_NULL"                                                               | "25"     |
      | "6234_SOL_Creative_01_DEDICATED_INVSTMNT_ADVISOR_F_eq_NULL"                                                  | "25"     |
      | "6234_SOL_Creative_01_PLN_ACCT_CD_MASTER_eq_RRSP_SRC_SYS_SUB_PRD_CD_BNSCSVRG_eq_SRC_SYS_PRD_CD_eq_RRS"       | "25"     |
      | "6234_SOL_Creative_01_PLN_ACCT_CD_MASTER_eq_RRSP_SRC_SYS_SUB_PRD_CD_BNSCSVRG_eq_SRC_SYS_PRD_CD_eq_RSS"       | "25"     |
      | "6234_SOL_Creative_01_PLN_ACCT_CD_MASTER_eq_RESP_SRC_SYS_SUB_PRD_CD_BNSCSVRX_eq_SRC_SYS_PRD_CD_eq_REF"       | "25"     |
      | "6234_SOL_Creative_01_PLN_ACCT_CD_MASTER_eq_RESP_SRC_SYS_SUB_PRD_CD_BNSCSVRX_eq_SRC_SYS_PRD_CD_eq_REI"       | "25"     |
      | "6234_SOL_Creative_01_PLN_ACCT_CD_MASTER_eq_TFSA_SRC_SYS_SUB_PRD_CD_BNSCSVTF_eq_SRC_SYS_PRD_CD_eq_TFS"       | "25"     |
      | "6234_SOL_Creative_01_ACCT_ODT_eq_20"                                                                        | "20"     |
      | "6234_SOL_Creative_01_ACCT_ODT_eq_30"                                                                        | "30"     |
      | "6234_SOL_Creative_01_PIC_PAC_F_eq_2"                                                                        | "25"     |
      | "N-6234_SOL_Creative_01_DECEASED_F_eq_Y"                                                                     | "25"     |
      | "N-6234_SOL_Creative_01_DECEASED_F_eq_NULL"                                                                  | "25"     |
      | "N-6234_SOL_Creative_01_CUST_TP_CD_eq_ABCD"                                                                  | "25"     |
      | "N-6234_SOL_Creative_01_PRIM_CNTRY_CD_eq_IN"                                                                 | "25"     |
      | "N-6234_SOL_Creative_01_PRIM_CNTRY_CD_eq_NULL"                                                               | "25"     |
      | "N-6234_SOL_Creative_01_CUST_AGE_eq_NULL"                                                                    | "25"     |
      | "N-6234_SOL_Creative_01_LANG_CD_eq_KA"                                                                       | "25"     |
      | "N-6234_SOL_Creative_01_MRKTBLE_F_eq_N"                                                                      | "25"     |
      | "N-6234_SOL_Creative_01_MRKTBLE_F_eq_NULL"                                                                   | "25"     |
      | "N-6234_SOL_Creative_01_ITRADE_MCLEOD_F_eq_Y"                                                                | "25"     |
      | "N-6234_SOL_Creative_01_DEDICATED_INVSTMNT_ADVISOR_F_eq_Y"                                                   | "25"     |
      | "N-6234_SOL_Creative_01_INDV_FRST_NM_eq_NULL"                                                                | "25"     |
      | "N-6234_SOL_Creative_01_INDV_LAST_NM_eq_NULL"                                                                | "25"     |
      | "N-6234_SOL_Creative_01_PLN_ACCT_DLR_ne_SSI"                                                                 | "25"     |
      | "N-6234_SOL_Creative_01_PLN_ACCT_DLR_eq_NULL"                                                                | "25"     |
      | "N-6234_SOL_Creative_01_ACCT_SUBSYS_ID_ne_UF"                                                                | "25"     |
      | "N-6234_SOL_Creative_01_ACCT_SUBSYS_ID_eq_NULL"                                                              | "25"     |
      | "N-6234_SOL_Creative_01_SRC_ACCT_STAT_CD_ne_Active"                                                          | "25"     |
      | "N-6234_SOL_Creative_01_SRC_ACCT_STAT_CD_eq_NULL"                                                            | "25"     |
      | "N-6234_SOL_Creative_01_ACCT_ODT_gt_30"                                                                      | "31"     |
      | "N-6234_SOL_Creative_01_ACCT_ODT_lt_20"                                                                      | "19"     |
      | "N-6234_SOL_Creative_01_ACCT_ODT_eq_NULL"                                                                    | "NULL"   |
      | "N-6234_SOL_Creative_01_PLN_ACCT_CD_MASTER_eq_LIF_SRC_SYS_SUB_PRD_CD_eq_BNSCSVRG_SRC_SYS_PRD_CD_eq_BNSCSVRG" | "25"     |
      | "N-6234_SOL_Creative_01_PRIMARY_ACCT_HOLDER_FLAG_eq_N"                                                       | "25"     |
      | "N-6234_SOL_Creative_01_PRIMARY_ACCT_HOLDER_FLAG_eq_NULL"                                                    | "25"     |
      | "N-6234_SOL_Creative_01_IP_AR_RELATN_TYPE_CD_ne_ANN_OR_OWN"                                                         | "25"     |
      | "N-6234_SOL_Creative_01_IP_AR_RELATN_TYPE_CD_eq_NULL"                                                        | "25"     |
      | "N-6234_SOL_Creative_01_PIC_PAC_F_eq_1"                                                                      | "25"     |


  @SSI_PAC_SOLTestData_2account @6234 @SOL @RS23175 @2accounts
  Scenario Outline: SSIPAC_RS23175_6234_SOL Create test data for 2 account scenarios
    ...
    * call read('classpath:channels/sol/ReusableScenarios.feature@ACCT_DIM_Insertion_Database') examples
    ...
    Examples:
      ...
      | "6234_SOL_Creative_01_ACCT_SUBSYS_ID_ne_SL_SRC_ACCT_STAT_CD_eq_Active_SRC_SYS_PRD_CD_eq_9_ACCT_ODT_eq_180"   | "25"      | "180"     |
      | "6234_SOL_Creative_01_ACCT_SUBSYS_ID_eq_SL_SRC_ACCT_STAT_CD_ne_Active_SRC_SYS_PRD_CD_eq_9_ACCT_ODT_eq_180"   | "25"      | "180"     |
      | "6234_SOL_Creative_01_ACCT_SUBSYS_ID_eq_SL_SRC_ACCT_STAT_CD_eq_Active_SRC_SYS_PRD_CD_ne_9_ACCT_ODT_eq_180"   | "25"      | "180"     |
      | "6234_SOL_Creative_01_ACCT_SUBSYS_ID_eq_SL_SRC_ACCT_STAT_CD_eq_Active_SRC_SYS_PRD_CD_eq_9_ACCT_ODT_eq_181"   | "25"      | "181"     |
      | "N-6234_SOL_Creative_01_ACCT_SUBSYS_ID_eq_SL_SRC_ACCT_STAT_CD_eq_Active_SRC_SYS_PRD_CD_eq_9_ACCT_ODT_eq_180" | "25"      | "180"     |
      | "N-6234_SOL_Creative_01_ACCT_SUBSYS_ID_eq_SL_SRC_ACCT_STAT_CD_eq_Active_SRC_SYS_PRD_CD_eq_9_ACCT_ODT_eq_179" | "25"      | "179"     |


  @SSI_PAC_SOLTestData_17account @6234 @SOL @RS23175 @17accounts
  Scenario Outline: SSIPAC_RS23175_6234_SOL Create test data for 17 account scenarios
    ...
    * call read('classpath:channels/sol/ReusableScenarios.feature@ACCT_DIM_Insertion_Database') examples
    ...
    Examples:
      | TestID                                                                                                     | ACCT_ODT |
      | "6234_SOL_Creative_01_NRS_LIF_LIRA_LRSP_LRIF_PRIF_RRIF_RLIF_RRIF_RRSP_RLSP_RRSP_RDSP_RESP_RESP_TFSA_FHSA" | "25"     |