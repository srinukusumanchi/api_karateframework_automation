...
Feature: Manual Test Cases For D2D Funds Account

  @4315 @SOL @RS18022 @MANUAL
  Scenario: Validate that 4315 offer is presented to customer till the persistance days and will not be displayed for the rest period
    Given condition the customer according to the 4315 eligibility criteria
