...
Feature: Create test data for D2D Engagement-Cross Sell-Email-BBP-BBA-4893 Disposition and Suppression test cases
  ...
  @D2DEngagementCrossSell_Email @D2DEngagementCrossSell_Email_BBP_BBA_ATC_DEL_Disposition_TestData @4893 @SOL @RS19067
  Scenario Outline: D2D Engagement-CrossSell_Email_BBP_BBA_RS19067_4893_SOL Create test data for accept or delete disposition
  ...
  # insert PURL_CUST_PROFILE sheet rows into the PURL_CUST_PROFILE database
    * call read('classpath:channels/sol/ReusableScenarios.feature@PURL_CUST_PROFILE_Insertion_Database')
    ...
    Examples:
      ...
      | "4893_Perform Accept Disposition and offer should not display" | "28"     | "18" | "30"         |
      | "4893_Perform Delete Disposition and offer should not display" | "29"     | "19" | "40"         |

  @D2DEngagementCrossSell_Email @D2DEngagementCrossSell_Email_BBP_BBA_VWD_RML_NTY_ATP_Disposition_TestData @4893 @SOL @RS19067
  Scenario Outline: D2D Engagement-CrossSell_Email_ScotiaOne_RS19067_4893_SOL Create test data for view or remind me later or no thank you or accept in progress disposition
  ...
  # insert PURL_CUST_PROFILE sheet rows into the PURL_CUST_PROFILE database
    * call read('classpath:channels/sol/ReusableScenarios.feature@PURL_CUST_PROFILE_Insertion_Database')
    ...
    Examples:
      | TestID                                                                   | Acct_Odt | DOB  | CUST_OPND_DT |
      | "4893_Perform Viewed Disposition and offer should display"               | "30"     | "20" | "20"         |
      | "4893_Perform Remind me later Disposition and offer should display"      | "31"     | "21" | "30"         |
      | "4893_Perform Accepted In Progress Disposition and offer should display" | "32"     | "22" | "40"         |
      | "4893_Perform No Thank You Disposition and offer should display"         | "33"     | "23" | "50"         |