...
Feature: Validate D2D Engagement-InteracFlash-4367 Disposition and Suppression test cases
...
#Accepted Complete (ATC), Deleted (DEL)
  @D2DEngagementInteracFlash @D2DEngagementInteracFlash_ATC_DEL_Disposition  @4367 @SOL @RS18039
  Scenario Outline: D2D Engagement-InteracFlash_RS18039_4367_SOL Validate <TestID> accept,delete disposition & suppression logic
...
#    request (Karate keyword) for sending request string
  ...
  #    Verfiying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                         |
      | "4367_Perform Accept Disposition and offer should not display" |
      | "4367_Perform Delete Disposition and offer should not display" |



    # Viewed(VWD), Reminder Me Later(RML), No Thank You (NTY), Accepted in Progress (ATP)
  @D2DEngagementInteracFlash @D2DEngagementInteracFlash_VWD_RML_NTY_ATP_Disposition @4367  @SOL @RS18039
  Scenario Outline: D2D Engagement-InteracFlash_RS18039_4367_SOL Validate <TestID> view or remind me later or no thank you or accept in progress disposition & suppression logic
    # Reading data from Excel sheet
    * def testDataFileName = InteractestDataFileName
...
#    request (Karate keyword) for sending request string
  ...
  #    Verfiying Success with status code 200
    ...
    * assert getLength(failedResults) == 0
    ...
    Examples:
      | TestID                                                                   |
      | "4367_Perform Viewed Disposition and offer should display"               |
      | "4367_Perform Remind me later Disposition and offer should display"      |
      | "4367_Perform Accepted In Progress Disposition and offer should display" |
      | "4367_Perform No Thank You Disposition and offer should display"         |